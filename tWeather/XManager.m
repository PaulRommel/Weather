...
@property (nonatomic, strong, readwrite) XCondition *currentCondition;
...
- (RACSignal *)updateCurrentConditions {
    return [[self.client fetchCurrentConditionsForLocation:self.currentLocation.coordinate] doNext:^(XCondition *condition) {
